...
class TestHeadClass(unittest.TestCase):
    ...
    def test_deve_retornar_arquivo_inexistente_caso_o_arquivo_nao_exista(self):
        ...
        self.assertEqual(h.le_comando('head ble.txt'), 'Arquivo inexistente')
